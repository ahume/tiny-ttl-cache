...
TTLCache.prototype.put = function (key, value) {
...
TTLCache.prototype.scheduleExpiryFlush = function (expiryTime) {
    var now = Date.now();
...
TTLCache.prototype.flush = function () {
    this._setup();
};

TTLCache.prototype._setup = function () {
    this.cache = {};
    this.itemList = [];
    this.cacheSize = 0;
};
